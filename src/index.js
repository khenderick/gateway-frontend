...
export class Index extends Base {
  constructor(router, authenication, appFactory, installationFactory, ...rest) {
    ...
    this.shared.setInstallation = async i => {
      await this.setInstallation(i);
    };
  }
  ...
  async activate() {
    ...
    let routes = [
      ...
      },
      {
        route: 'dashboard',
        name: 'dashboard',
        moduleId: PLATFORM.moduleName('pages/dashboard', 'pages'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'dashboard',
          title: this.i18n.tr('pages.dashboard.title'),
          group: 'installation',
        },
      },
      {
        route: 'outputs',
        name: 'outputs',
        moduleId: PLATFORM.moduleName('pages/outputs', 'pages'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'outputs',
          title: this.i18n.tr('pages.outputs.title'),
          group: 'installation',
        },
      },
      ...Toolbox.iif(
        this.shared.target !== 'cloud',
        [
          {
            route: 'thermostats',
            name: 'thermostats',
            moduleId: PLATFORM.moduleName('pages/gateway/thermostats', 'pages'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              key: 'thermostats',
              title: this.i18n.tr('pages.thermostats.title'),
              group: 'installation',
            },
          },
        ],
        [
          {
            route: 'thermostats',
            name: 'thermostatscloud',
            moduleId: PLATFORM.moduleName('pages/cloud/thermostats', 'pages'),
            nav: true,
            auth: true,
            land: true,
            show: true,
      ...
      ),
      {
        route: 'energy',
        name: 'energy',
        moduleId: PLATFORM.moduleName('pages/energy', 'pages'),
        nav: true,
        auth: true,
        land: true,
        show: this.shared.target === 'cloud' ? false : true,
        settings: {
          key: 'energy',
          title: this.i18n.tr('pages.energy.title'),
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      },
      {
        route: 'settings',
      ...
      {
        route: 'settings/initialisation',
        name: 'settings.initialisation',
        moduleId: PLATFORM.moduleName('pages/settings/initialisation', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.initialisation',
          title: this.i18n.tr('pages.settings.initialisation.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      ...
      {
        route: 'settings/outputs',
        name: 'settings.outputs',
        moduleId: PLATFORM.moduleName('pages/settings/outputs', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.outputs',
          title: this.i18n.tr('pages.settings.outputs.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      },
      {
        ...
        moduleId: PLATFORM.moduleName('pages/settings/inputs', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.inputs',
          title: this.i18n.tr('pages.settings.inputs.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      },
      {
        ...
        name: 'settings.sensors',
        moduleId: PLATFORM.moduleName('pages/settings/sensors', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.sensors',
          title: this.i18n.tr('pages.settings.sensors.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      ...
      {
        route: 'settings/thermostats',
        name: 'settings.thermostats',
        moduleId: PLATFORM.moduleName('pages/settings/thermostats', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.thermostats',
          title: this.i18n.tr('pages.settings.thermostats.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      ...
      {
        route: 'settings/groupactions',
        name: 'settings.groupactions',
        moduleId: PLATFORM.moduleName('pages/settings/groupactions', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.groupactions',
          title: this.i18n.tr('pages.settings.groupactoins.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      ...
      {
        route: 'settings/floors',
        name: 'settings.floorsandrooms',
        moduleId: PLATFORM.moduleName('pages/settings/floors-rooms', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.floorsandrooms',
          title: this.i18n.tr('pages.settings.floorsandrooms.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      },
      {
        ...
        moduleId: PLATFORM.moduleName('pages/settings/environment', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          ...
          title: this.i18n.tr('pages.settings.environment.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
        ...
        [
          {
            ...
            name: 'settings.cloud',
            moduleId: PLATFORM.moduleName('pages/settings/cloud', 'pages.settings'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              key: 'settings.cloud',
              title: this.i18n.tr('pages.settings.cloud.title'),
              parent: 'settings',
              group: 'installation',
            },
          },
        ...
        [
          {
            route: 'landing',
            name: 'cloud.landing',
            moduleId: PLATFORM.moduleName('pages/cloud/landing', 'pages.cloud'),
            nav: false,
            auth: true,
            land: true,
            show: true,
            settings: {
              key: 'cloud.landing',
              title: this.i18n.tr('generic.landingpage.title'),
              group: 'landing',
            },
          },
          {
            ...
            name: 'settings.users',
            moduleId: PLATFORM.moduleName('pages/settings/users', 'pages.settings'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              key: 'settings.users',
              title: this.i18n.tr('pages.settings.users.title'),
              parent: 'settings',
              group: 'installation',
              needInstallationAccess: ['configure'],
            },
          },
          {
            ...
            moduleId: PLATFORM.moduleName('pages/settings/backups', 'pages.settings'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              ...
              title: this.i18n.tr('pages.settings.backups.title'),
              parent: 'settings',
              group: 'installation',
              needInstallationAccess: ['configure'],
            },
          ...
          {
            route: 'cloud/nopermission',
            name: 'cloud.nopermission',
            moduleId: PLATFORM.moduleName('pages/cloud/nopermission', 'pages.cloud'),
            nav: false,
            auth: true,
            land: true,
            show: true,
          ...
          },
          {
            ...
            moduleId: PLATFORM.moduleName('pages/settings/updates', 'pages.updates'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              ...
              title: this.i18n.tr('pages.settings.updates.title'),
              parent: 'settings',
              group: 'installation',
              needInstallationAccess: ['configure'],
            },
          },
          {
            ...
            name: 'settings.eventrules',
            moduleId: PLATFORM.moduleName('pages/settings/eventrules', 'pages.settings'),
            nav: true,
            auth: true,
            land: true,
            show: true,
            settings: {
              key: 'settings.eventrules',
              title: this.i18n.tr('pages.eventrules.title'),
              parent: 'settings',
              group: 'installation',
              needInstallationAccess: ['configure'],
            },
      ...
      ),
      {
        ...
        moduleId: PLATFORM.moduleName('pages/settings/schedules', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: false,
        settings: {
          ...
          title: this.i18n.tr('pages.settings.schedules.title'),
          parent: 'settings',
          group: 'installation',
          needsFeature: 'scheduling',
          needInstallationAccess: ['configure'],
        },
      },
      {
        route: 'settings/apps',
        name: 'settings.apps',
        moduleId: PLATFORM.moduleName('pages/settings/apps', 'pages.settings'),
        nav: true,
        auth: true,
        land: true,
        show: true,
        settings: {
          key: 'settings.apps',
          title: this.i18n.tr('pages.settings.apps.title'),
          parent: 'settings',
          group: 'installation',
          needInstallationAccess: ['configure'],
        },
      ...
      ...Toolbox.iif(
        ...
        [
          {
            route: 'apps/:reference',
            name: 'apps.index',
            moduleId: PLATFORM.moduleName('pages/apps/index', 'pages.apps'),
            nav: false,
            auth: true,
            land: true,
            show: true,
        ...
        [
          {
            route: 'cloud/installations',
            name: 'cloud.installations',
            moduleId: PLATFORM.moduleName('pages/cloud/installations', 'pages.cloud'),
            nav: true,
            auth: true,
            land: true,
            show: false,
            settings: {
              key: 'cloud.installations',
              title: this.i18n.tr('pages.cloud.installations.title'),
              group: 'installation',
            },
          },
          {
            route: 'cloud/profile',
            name: 'cloud.profile',
            moduleId: PLATFORM.moduleName('pages/cloud/profile', 'pages.cloud'),
            nav: true,
            auth: true,
            land: false,
            show: true,
            settings: {
              key: 'cloud.profile',
              title: this.i18n.tr('pages.cloud.profile.title'),
              group: 'profile',
            },
          },
          {
            route: 'cloud/oauth',
            name: 'cloud.oauth',
            moduleId: PLATFORM.moduleName('pages/cloud/oauth', 'pages.cloud'),
            nav: true,
            auth: true,
            land: false,
            show: true,
            settings: {
              key: 'cloud.oauth',
              title: this.i18n.tr('pages.cloud.oauth.title'),
              group: 'profile',
            },
          },
        ],
      ),
      {
        route: 'logout',
        name: 'logout',
        moduleId: PLATFORM.moduleName('pages/logout', 'main'),
        nav: true,
        auth: false,
        land: false,
        show: true,
          ...
          if (navigationInstruction.config.settings.needInstallationAccess !== undefined) {
            ...
            if (this.shared.target === 'cloud') {
              ...
              hasAccess =
                this.shared.installation === undefined
                  ? false
                  : this.shared.installation.hasAccess(navigationInstruction.config.settings.needInstallationAccess);
            }
            if (!hasAccess) {
  ...
  detached() {
    window.removeEventListener('aurelia-composed', () => {
      $('body').layout('fix');
    });
