...
describe('the translation file', () => {
    ...
    it('should contain translations for every key', () => {
        ...
        list_of_failures = check_translation_against_base(dict_base, dict_translation, "");
        expect(list_of_failures.length).toEqual(1);  // expecting 1 missing translation to be logged.
        failures = [];
